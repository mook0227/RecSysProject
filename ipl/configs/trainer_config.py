configs = {
    ...
    'ipl': lambda args: {
        'name': 'IPLBPRTrainer', 'optimizer': 'Adam',
        'n_epochs': 2000, 'batch_size': 512, 'dataloader_num_workers': 6,
        'test_batch_size': 512, 'topks': [5, 10, 20], 'eval_fairk': 20,
        'lr': args.lr, 'l2_reg': args.wd, 'device': args.device, 
        'lambda_f': args.lambda_f, 'gamma': args.gamma, 'model_name': args.model,
        'save_flag': args.save_flag, 'dataset_name': args.data
    },
}
